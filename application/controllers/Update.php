...
class Update extends CI_Controller {
	...
	public function index()
	{
		...
		$result=$this->User_model->update($id,$nickname,$username,$date,$hospital,$department,$doctorName,$assistantName,$medicalRecordNo,$patientName,$patientAge,$patientSex,$diagnosis,$operationName,$optStartTime,$optEndTime,$optSite,$optroute,$optsegement,$cuteBoneSegment,$cbStartTime,$cbEndTime,$powerStall,$flowStall,$pulseStall,$knife1UseStyle,$knife1type,$knife2UseStyle,$knife2type,$knife3UseStyle,$knife3type,$bloodingSize,$selfBloodReturnSize,$bloodInSize,$putamenHarm,$putamenHarmReason,$cerebroLeakage,$cerebroLeakageReason,$nerveHurt,$nerveHurtReason,$elecPhyTest,$elecPhyTestReason,$optAwaken,$optAwakenReason,$knifeAbrasion,$knifeAbrasionReason,$otherException,$followCommit,$doctorSugest);
		if($result)
		{
