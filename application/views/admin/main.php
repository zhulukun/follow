			...
			<div class="form">
				<div class="form-group">
					<div class="col-xs-12 ">
						<div class="input-group">
							<input type="text" id="nickname" name="nickname" class="form-control" placeholder="昵称" style="border-radius:6px;">
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							<input type="password" id="password" name="password" class="form-control" placeholder="设定密码" style="border-radius:6px;">
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							<input type="password" id="repassword" name="repassword" class="form-control" placeholder="确认密码" style="border-radius:6px;">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group loginbtn" style="margin-top:16px">
						<button type="submit" class="btn btn-sm btn-info" id="submit">添加</button>
					</div>
					</div>
				</div>
