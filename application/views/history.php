...
<div class="container" style="margin-bottom:120px;">
  <div class="row" style="text-align: center;margin-top: 5%;">
    ...
    <ul>
     ...
     <li> <a href="<?php echo base_url();?>index.php/historyInfo/index/id/<?php echo $item['id'];?>" class="list-group-item">
       <?php echo $item['nickname'];?> <?php echo $item['hospital']?> <?php echo $item['date'];?>跟台信息
      </a></li>
    <?php endforeach; ?>  
